export default function ComputerNetworkIcon({ className }: { className?: string }) {
    return (
        <svg  
            className={className}
            version="1.1" 
	        ...
	        viewBox="0 0 28.801 28.801" 
        >
            <g>
                <g>
                    <path 
                        className="fill:#010002;" 
                        d="M9.038,22.149H9.14v-1.114c-4.489-0.42-8.017-4.208-8.017-8.805c0-4.879,3.968-8.846,8.846-8.846
                    ...
                    <path 
                        className="fill:#010002;" 
                        d="M10.095,8.395c0.498,0.012,0.995,0.042,1.492,0.087c0.185,1.186,0.26,2.379,0.237,3.573h1.121
                    ...
                    <path 
                        className="fill:#010002;" 
                        d="M27.064,21.917v-5.089v-4.22H15.486H9.842v4.307v5.002h10.876H27.064z M10.39,17.056V13.32h4.739
                        h11.386v3.304l0,0v4.583h-5.439H10.39V17.056L10.39,17.056z"
                    />
                    <polygon 
                        className="fill:#010002;" 
                        points="8.241,26.539 28.523,26.539 28.673,26.04 8.051,26.04"
                    />
                    <path 
                        className="fill:#010002;" 
                        d="M27.713,22.702H9.441l-1.388,3.079h20.699l0.049-0.168L27.713,22.702z M16.766,25.648l0.328-0.986
