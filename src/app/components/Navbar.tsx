        ...
        >
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-6">
                    <Link href="/#about" className="text-[var(--foreground)] hover:text-[var(--color-name-logo)]">
                        <span className="flex items-center gap-2"> {/* Wrapper */}
                            <FiUser className="h-4 w-4" /> {/* Icon */}
                            ABOUT
                        </span>
                    </Link>
                    <Link href="/#experience" className="text-[var(--foreground)] hover:text-[var(--color-name-logo)]">
                        <span className="flex items-center gap-2">
                            <FiBriefcase className="h-4 w-4" />
                            EXPERIENCE
                        </span>
                    </Link>
                    <Link href="/#projects" className="text-[var(--foreground)] hover:text-[var(--color-name-logo)]">
                        <span className="flex items-center gap-2">
                            <FiCode className="h-4 w-4" />
                            PROJECTS
                        </span>
                    </Link>
                    <Link href="/gallery" className="text-[var(--foreground)] hover:text-[var(--color-name-logo)]">
                        <span className="flex items-center gap-2">
                    ...
                    <Link
                        href="/#contact"
                        className="bg-[var(--primary)] text-white px-4 py-2 rounded-md hover:opacity-90 hover:text-[var(--color-name-logo)] flex items-center gap-2" // Added flex items-center gap-2
                    >
